...
APP_TITLE	:=	DEEP HARNESS SWITCH
APP_AUTHOR	:=	deep-harness-switch
APP_VERSION	:=	0.1.0
...
LIBS	:=	`$(PORTLIBS)/bin/sdl2-config --libs` \
			-lSDL2_ttf -lfreetype -lharfbuzz -lpng16 -lbz2 -lz -lm
